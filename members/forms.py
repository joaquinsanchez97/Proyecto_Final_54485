...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label="Repetir nueva contraseña", max_length=30, widget=forms.PasswordInput(attrs={'class': 'form-control', 'type':'password'}))
    old_password = forms.CharField(label="Contraseña antigua", max_length=30, widget=forms.PasswordInput(attrs={'class': 'form-control', 'type':'password'}))
